...
@Configuration
@ConditionalOnClass({ApiInfo.class, BeanValidatorPluginsConfiguration.class, ApplicationSwaggerProperties.class})
...
public class SwaggerConfiguration
{
    ...
    @Bean
    public Docket swaggerSpringfoxDocket(ApplicationSwaggerProperties properties)
    {
