...
public enum ReflectionUtil
{
     ...
     */
    public void invokeSetter(Object obj, String propertyName, Object value, Class<?> propertyType)
    {
...
//                e.printStackTrace();
    ...
    public <T> Class<T> getSuperClassGenricType(@SuppressWarnings("rawtypes") final Class clazz)
    {
     ...
     * @return
     */
    public boolean isFieldNullSimple(Object object, String... excludeField)
    {
     ...
     * @return
     */
    public Map<String, Object> getFieldMapForClass(Object object)
    {
