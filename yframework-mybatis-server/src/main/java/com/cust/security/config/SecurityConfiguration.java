...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        http.addFilterBefore(corsFilter, UsernamePasswordAuthenticationFilter.class).
                ...
                authorizeRequests().
                antMatchers("/mgt/dicts/type/**").permitAll().
                antMatchers("/mgt/health").permitAll().
                antMatchers("/mgt/info").permitAll().
//                antMatchers("/mgt/**").permitAll().
        antMatchers("/mgt/**").authenticated().
                antMatchers("/websocket/tracker").hasAuthority(AuthoritiesConstants.ADMIN).
                antMatchers("/websocket/**").permitAll().
                antMatchers("/v2/api-docs/**").permitAll().
                antMatchers("/swagger-resources/configuration/ui").permitAll().
                antMatchers("/apidoc/index.html").hasAuthority(AuthoritiesConstants.ADMIN).
